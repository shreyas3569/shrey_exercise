...
namespace Drupal\shrey_exercise\Plugin\Field\FieldFormatter;
...
class FieldFormatter extends FormatterBase {
  ...
  public static function defaultSettings() {
    return [
      'concat' => 'Concat with ',
    // This will return the defaultSettings value.
  ...
  public function settingsSummary() {
    $summary = [];
    // This will concatenate with @concat.
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      ...
      $element[$delta] = [
      // This will return concat and value submited in the frontend.
